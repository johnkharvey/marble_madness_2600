...
FrameCounter = $82
LevelNumber = $83
LeftNumber = $84 ; and $85
RightNumber = $86 ; and $87
...
LeftEdgeCollision
	...
	LDA	#0
	STA	Player0SpeedLeft
	STA	Player0SpeedRight ; for good measure
	;INC	Player0HPosition
	LDA	#16
	STA	Player0HPosition
...
RightEdgeCollision
	...
	LDA	#0
	STA	Player0SpeedRight
	STA	Player0SpeedLeft ; for good measure
	;DEC	Player0HPosition
	LDA	#136
	STA	Player0HPosition
...
;SWCHAHorizOffsetTable
;	; right, left, down, up
;	dc.b	3	; 0000 - all directions ; impossible
;	dc.b	3	; 0001 - 3 directions ; impossible
;	dc.b	3	; 0010 - 3 directions ; impossible
;	dc.b	3	; 0011 - right and left ; impossible
;	;------------
;	dc.b	7	; 0100 - 3 directions; impossible
;	dc.b	7	; 0101 - right and down
;	dc.b	7	; 0110 - right and up
;	dc.b	7	; 0111 - right only
;	;------------
;	dc.b	0	; 1000 - 3 directions ; impossible
;	dc.b	0	; 1001 - left and down
;	dc.b	0	; 1010 - left and up
;	dc.b	0	; 1011 - left only
;	;------------
;	dc.b	3	; 1100 - up and down ; impossible
;	dc.b	3	; 1101 - down only
;	dc.b	3	; 1110 - up only
;	dc.b	3	; 1111 - no movement

;SWCHAVertOffsetTable
;	; right, left, down, up
;	dc.b	2	; 0000 - all directions ; impossible
;	dc.b	3	; 0001 - 3 directions ; impossible
;	dc.b	0	; 0010 - 3 directions ; impossible
;	dc.b	2	; 0011 - right and left ; impossible
;	;------------
;	dc.b	2	; 0100 - 3 directions; impossible
;	dc.b	3	; 0101 - right and down
;	dc.b	0	; 0110 - right and up
;	dc.b	2	; 0111 - right only
;	;------------
;	dc.b	2	; 1000 - 3 directions ; impossible
;	dc.b	3	; 1001 - left and down
;	dc.b	0	; 1010 - left and up
;	dc.b	2	; 1011 - left only
;	;------------
;	dc.b	2	; 1100 - up and down ; impossible
;	dc.b	3	; 1101 - down only
;	dc.b	0	; 1110 - up only
;	dc.b	2	; 1111 - no movement
...
CollisionTable1
	...
	dc.b	14
	dc.b	15
	dc.b	16 ; incorrect here and above
	dc.b	17
	dc.b	18
	dc.b	19
	dc.b	18
